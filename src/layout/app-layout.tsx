...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'booking-manager', 'technical-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Movies', path: '/movies', entity: 'movie', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Showings', path: '/showings', entity: 'showing', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
