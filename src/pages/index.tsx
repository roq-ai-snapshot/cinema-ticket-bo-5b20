  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cinema Ticket Booking System - Streamlining your movie experience with a few easy steps. Experience hassle-free ticket reservation anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1478720568477-152d9b164e26?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaW5lbWF8ZW58MHx8fHwxNjk4MDQ5ODkzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Cinema Ticket Booking System - Streamlining your movie experience with a few easy steps. Experience hassle-free ticket reservation anytime, anywhere.`}
            </Text>
            <Box
