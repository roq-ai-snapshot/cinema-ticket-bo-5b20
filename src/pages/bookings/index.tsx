  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.booking_time ? format(record?.booking_time, 'dd-MM-yyyy') : '',
    },
    { id: 'number_of_tickets', header: 'number_of_tickets', accessorKey: 'number_of_tickets' },
    ...
    hasAccess('showing', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'showing',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/showings/view/${record.showing?.id}`}>
              {record.showing?.showing_time}
            </Link>
          ),
        }
      : null,
