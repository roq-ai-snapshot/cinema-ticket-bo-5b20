...
export function MovieListPage(props: MovieListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'showing.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['title.contains', 'director.contains', 'genre.contains'],
          ...params.filters,
        },
        'movie',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'director', header: 'Director', accessorKey: 'director' },
    ...
    hasAccess('showing', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Showing',
          accessorKey: 'showing',
          cell: ({ row: { original: record } }: any) => record?._count?.showing,
        }
      : null,
